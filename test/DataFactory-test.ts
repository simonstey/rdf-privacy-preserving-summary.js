...
describe('DataFactory', () => {
  let factory: KeyGeneration;

  beforeEach(() => {
    factory = new KeyGeneration({
      algorithm: 'aes256',
      inputEncoding: 'utf8',
      outputEncoding: 'hex',
      ivlength: 16,
  ...
  describe('namedNode', () => {
    it('should produce a valid named node', () => {
      const cipher: string = factory.encrypt('asdasd');
      const deciphered = factory.decrypt(cipher);
      const deciphered_customKey = factory.decrypt(cipher, 'ciw7p02f70000ysjon7gztjn7c2x7GfJ');
      const deciphered_wrongCustomKey = factory.decrypt(cipher, 'wrong_key');
